...
//
// Pure structural fork of templates/notificationEmail.js — the same DOM,
// the same CSS classes, the same paddings, the same 600px breakpoint,
// the same action-button. The only additions are:
//   1. A small .count-pill style for the "total active subscribers"
//      badge — it sits inside an .info-value row.
//   2. One extra .info-label/.info-value pair (Subscribed at IST).
// We do NOT include the standalone Message label + .message-box section
// from the original because there's no message to display for a
// subscriber.
//
